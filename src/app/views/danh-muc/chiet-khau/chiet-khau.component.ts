...
@Component({
  selector: 'app-chiet-khau',
  templateUrl: './chiet-khau.component.html',
  styleUrls: ['./chiet-khau.component.scss']
})
export class ChietKhauComponent implements OnInit {
  listOfData: any[] = [];
  listOfDatatmp: any[] = [];
  loading: boolean;
  spinning: boolean;
  ...
  addNewItem() {
    const modal = this.modal.create({
      nzTitle: 'Thêm mới',
      nzContent: AddEditChietKhauModalComponent,
      nzClosable: false,
      nzFooter: 'null',
      nzWidth: '25%',
      nzStyle: {
