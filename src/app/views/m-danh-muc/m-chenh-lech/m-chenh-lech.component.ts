...
@Component({
  selector: 'app-m-chenh-lech',
  templateUrl: './m-chenh-lech.component.html',
  styleUrls: ['./m-chenh-lech.component.scss']
})
export class MChenhLechComponent implements OnInit {
    ...
    this._actionSheet.showActionSheetWithOptions(
      ...
      buttonIndex => {
        if (buttonIndex === 0)
          ...
          this.removeItem(data.chenhLechId);
      }
    );
