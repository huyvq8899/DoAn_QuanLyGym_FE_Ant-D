...
@Component({
  selector: 'app-add-edit-don-hang-thuong-mai-modal',
  templateUrl: './add-edit-don-hang-thuong-mai-modal.component.html',
  styleUrls: ['./add-edit-don-hang-thuong-mai-modal.component.scss']
})
export class AddEditDonHangThuongMaiModalComponent implements OnInit {
    ...
    if (this.isAddNew === true) {
      ...
      this.DonHangService.Insert(this.donBanHangForm.getRawValue()).subscribe((rs:any)=>{
        if(rs===1){
          ...
          this.modal.destroy( this.donBanHangForm.getRawValue());
