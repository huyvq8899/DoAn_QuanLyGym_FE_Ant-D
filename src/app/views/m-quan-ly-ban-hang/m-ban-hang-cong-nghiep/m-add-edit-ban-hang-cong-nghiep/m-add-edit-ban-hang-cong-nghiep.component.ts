...
@Component({
  selector: 'app-m-add-edit-ban-hang-cong-nghiep',
  templateUrl: './m-add-edit-ban-hang-cong-nghiep.component.html',
  styleUrls: ['./m-add-edit-ban-hang-cong-nghiep.component.scss']

})
export class MAddEditBanHangCongNghiepComponent implements OnInit {
  isAddNew: boolean;
  tmpp= false;
  data: any;
  checkbb = false;
  ...
  ngOnInit() {
    ...
    if (this.isAddNew) {
      ...
      this.sharedService.emitChange({
        title: 'Cập nhật đơn hàng ' + this.data.maDonHang
      });
      this.tinhLoiNhuan();
      if (this.data.chenhLechGiaFullName != 'Khác')
        this.donBanHangForm.get('chenhLechGia').disable();
      if (this.roleId === 'NVKD' && (this.data.trangThai === 0 || this.data.trangThai === 1 || this.data.trangThai === 6 || this.data.trangThai === 8)) {
        this.donBanHangForm.get('soLuongThucTe').disable();
        this.donBanHangForm.get('tinhTrangXe').disable();
        this.donBanHangForm.get('xeId').disable();
        this.donBanHangForm.get('tenLaiXe').disable();
      ...
      {
        this.donBanHangForm.get('chuyenDon').enable();
      }
        ...
        if (this.roleId === 'DX' && (this.data.trangThai === 2 || this.data.trangThai === 5 || this.data.trangThai === 7)) {
        ...
        else if (this.roleId === 'KT')//enable form cho kế toán
        {
          ...
          if (this.roleId === 'KT' && this.data.trangThai === 11 || this.data.trangThai === 12 || this.data.trangThai === 13) {
  ...
  changeVungChietKhau(event: any) {
    ...
    else if (this.roleId === 'NVKD') {
      if (this.data.trangThai === 0 || this.data.trangThai === 1 || this.data.trangThai === 6 || this.data.trangThai === 8) {
        const data = this.chietkhaus.find(x => x.id === event);
        if (data.vungChietKhau === "Khác") {
          if (this.chietkhauct > 0)
            this.donBanHangForm.get('chietKhauCongTy').setValue(this.data.chietKhauCongTy);
  ...
  duyet() {
    if (this.donBanHangForm.get('loiNhuan').value >= this.loinhuans[0].mucLoiNhuan) {
      ...
      if (this.donBanHangForm.get('soLuongThucTe').value === 0 && this.roleId === 'DX') {
        ...
        else if ((this.data.trangThai === 0 || this.data.trangThai === 1 || this.data.trangThai === 6 || this.data.trangThai === 8) && this.roleId === 'NVKD') {
          content = 'Bạn có chắc chắn muốn đẩy đơn hàng này đến nhân viên điều xe hay không?';
          status = 2;
        }
        else if (this.data.trangThai === 2 && this.roleId === 'DX') {
          content = 'Bạn có chắc chắn muốn duyệt xác nhận cho đơn hàng này không?';
          status = 3;
        }
        ...
        else if ((this.data.trangThai === 5 || this.data.trangThai === 7) && this.roleId === 'DX') {
    ...
    if (this.isAddNew === false) {
      if (isDuyet === true) {
        ...
        if (this.roleId === 'PPKD' && this.data.trangThai == 3)
          return true;
        if (this.roleId === 'BLD' && this.data.trangThai == 4)
          return true;
      }
  ...
  submitForm() {
    ...
    if (this.isAddNew === true) {
      ...
      if ((this.data.trangThai === 6 || this.data.thanhToan === 8) && this.roleId === 'NVKD') {
        if (this.donBanHangForm.get('trangThai').value === 2)
          data.trangThai = 2;
        else
          data.trangThai = 1;
      }
      if (this.roleId === 'KT' && this.data.thanhToan === 2) {
        if (data.tinhTrangThanhToan === 0) {
          data.trangThai = 12;
        }
        if ((data.tinhTrangThanhToan === 1 || this.data.tinhTrangThanhToan === 1) && (this.data.soHoaDon == null || data.soHoaDon == null)) {
          data.trangThai = 13;
        }
        if ((data.tinhTrangThanhToan === 1 || this.data.tinhTrangThanhToan === 1) && (this.data.soHoaDon != null || data.soHoaDon != null)) {
          data.trangThai = 14;
      ...
      if (this.roleId === 'GNLX' && this.data.thanhToan === 1 && data.trangThai === 11 && this.data.tinhTrangThanhToan === 1 && this.data.soHoaDon != null) {
        data.trangThai = 14;
      }
      if (this.roleId === 'GNLX' && this.data.thanhToan === 1 && data.trangThai === 11 && this.data.tinhTrangThanhToan === 0) {
        data.trangThai = 12;
      }
      if (this.roleId === 'GNLX' && this.data.thanhToan === 1 && data.trangThai === 11 && this.data.tinhTrangThanhToan === 1 && this.data.soHoaDon == null) {
        data.trangThai = 13;
      }
      if (this.roleId === 'KT' && this.data.thanhToan === 1 && this.data.fileBienBan != null) {
        if (data.tinhTrangThanhToan === 0) {
          data.trangThai = 12;
        }
        if ((data.tinhTrangThanhToan === 1 || this.data.tinhTrangThanhToan === 1) && (this.data.soHoaDon == null || data.soHoaDon == null)) {
  ...
  checkSave() {
    if ((this.roleId === 'NVKD' || this.roleId === 'BLD') && this.isAddNew)
      ...
      return true;
    else if (this.roleId === 'DX' && (this.data.trangThai == 2 || this.data.trangThai == 5 || this.data.trangThai == 7))
      return true;
    else if (this.roleId === 'KT' && this.data.thanhToan === 2 && (this.data.trangThai == 11 || this.data.trangThai == 12 || this.data.trangThai == 13)) {
      this.checkfdk = false;
      return true;
    }
    else if (this.roleId === 'KT' && this.data.thanhToan === 1 && this.data.trangThai != 14) {
      this.checkfdk = false;
      return true;
    }
    else if (this.roleId === 'BLD' && this.data.trangThai == 15) {
