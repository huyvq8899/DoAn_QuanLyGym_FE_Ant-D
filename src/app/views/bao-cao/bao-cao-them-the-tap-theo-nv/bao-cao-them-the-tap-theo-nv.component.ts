...
@Component({
  selector: 'app-bao-cao-them-the-tap-theo-nv',
  templateUrl: './bao-cao-them-the-tap-theo-nv.component.html',
  styleUrls: ['./bao-cao-them-the-tap-theo-nv.component.scss']
})
export class BaoCaoThemTheTapTheoNvComponent implements OnInit {
  ...
  GetAllLoi() {
    ...
    this.userService.GetAddTheTapByNhanVien(model,this.userId,this.selectedId).subscribe((rs: any) => {
      this.spinning = false;
      this.chartData = rs;
      console.log(this.chartData);
      // title
      this.title = "Thống kê thẻ tập đã thêm tháng ";
