...
@Component({
  selector: 'app-thong-ke-so-luong-the-tap',
  templateUrl: './thong-ke-so-luong-the-tap.component.html',
  styleUrls: ['./thong-ke-so-luong-the-tap.component.scss']
})
export class ThongKeSoLuongTheTapComponent implements OnInit {
  ...
  LoadData() {
    ...
    this.userService
      .GetBySoLuongCard(this.displayData)
      .subscribe((data: any) => {
  ...
  findsum(data){   
    ...
    for(let j=0;j<data.length;j++){   
         this.total+= this.value[j].soLuongTheTap   
    }  
